...
VALUES ('BCDEFG02HIJKLMN2', 'Giulia', 'Verdi', '1992-05-15', 'Milano', 'Italia', 'Milano', 'Via Manzoni, 12', 'Lombardia', 'Italia', 'giulia.verdi@gmail.com', '+39 3456789123', 'f', 2, true);

INSERT INTO candidate (fiscal_code, name, surname, birth_date, city_of_birth, country_of_birth, city_of_residence, street_of_residence, region_of_residence, country_of_residence, email, phone_number, gender, expertise_id, is_active)
VALUES ('DEFGHI04JKLMN4', 'Alessia', 'Bianchi', '1994-12-31', 'Firenze', 'Italia', 'Firenze', 'Via dei Tornabuoni, 50', 'Toscana', 'Italia', 'alessia.bianchi@gmail.com', '+39 3331234567', 'f', 1, true);

INSERT INTO candidate (fiscal_code, name, surname, birth_date, city_of_birth, country_of_birth, city_of_residence, street_of_residence, region_of_residence, country_of_residence, email, phone_number, gender, expertise_id, is_active)
VALUES ('CDEFGH03IJKLMN3', 'Vincenzo', 'Franchi', '1995-01-01', 'Napoli', 'Italia', 'Napoli', 'Via Toledo, 100', 'Campania', 'Italia', 'mario.rossi2@gmail.com', '+39 4675894022', 'm', 3, true);

INSERT INTO candidate (fiscal_code, name, surname, birth_date, city_of_birth, country_of_birth, city_of_residence, street_of_residence, region_of_residence, country_of_residence, email, phone_number, gender, expertise_id, is_active)
VALUES ('ABCDEF01GHIJKLN1', 'Mario', 'Rossi', '1990-01-01', 'Roma', 'Italia', 'Roma', 'Via del Corso, 123', 'Lazio', 'Italia', 'mario.rossi@gmail.com', '+39 64773892836', 'm', 1, true);

INSERT INTO candidate (fiscal_code, name, surname, birth_date, city_of_birth, country_of_birth, city_of_residence, street_of_residence, region_of_residence, country_of_residence, email, phone_number, gender, expertise_id, is_active)
VALUES ('RSSMRA90E41A001A', 'Samanta', 'Rossini', '1990-08-12', 'Bologna', 'Italia', 'Milano', 'Via Manzoni', 'Lombardia', 'Italia', 'samanta.rossini@gmail.com', '+39 3321234567', 'f', 2, true);

INSERT INTO candidate (fiscal_code, name, surname, birth_date, city_of_birth, country_of_birth, city_of_residence, street_of_residence, region_of_residence, country_of_residence, email, phone_number, gender, expertise_id, is_active)
VALUES ('BRTGNN91H54G333X', 'Hassan', 'Bertogna', '1991-11-23', 'Napoli', 'Italia', 'Roma', 'Via Appia Nuova', 'Lazio', 'Italia', 'hassan.bertogna@gmail.com', '+39 3479876543', 'm', 3, true);

INSERT INTO candidate (fiscal_code, name, surname, birth_date, city_of_birth, country_of_birth, city_of_residence, street_of_residence, region_of_residence, country_of_residence, email, phone_number, gender, expertise_id, is_active)
VALUES ('LCNCST92P47H501Z', 'Paola', 'Liconasti', '1992-05-04', 'Palermo', 'Italia', 'Firenze', 'Via  Tornabuoni', 'Toscana', 'Italia', 'paola.liconasti@gmail.com', '+39 3204567890', 'f', 1, true);
...
VALUES ('2023-03-01', '10:00:00', 'Milano', 1, 4, 3, 4, 'Ottimo candidato', 1, 1, true);

INSERT INTO job_interview(date, hour, place, candidate_id, employee_id, job_position_id, rating, note, job_interview_status_id, job_interview_type_id, is_active)
VALUES ('2023-03-05', '9:00:00', 'Firenze', 2, 4, 2, 3, 'Non ha le competenze richieste', 3, 2, true);

INSERT INTO job_interview(date, hour, place, candidate_id, employee_id, job_position_id, rating, note, job_interview_status_id, job_interview_type_id, is_active)
VALUES ('2023-03-04', '16:30:00', 'Napoli', 4, 4, 1, 5, 'Eccellente esperienza', 1, 3, true);

INSERT INTO job_interview(date, hour, place, candidate_id, employee_id, job_position_id, rating, note, job_interview_status_id, job_interview_type_id, is_active)
VALUES ('2023-03-02', '11:30:00', 'Roma', 3, 4, 4, 3, 'Non adatto alla posizione', 3, 2, true);

INSERT INTO job_interview(date, hour, place, candidate_id, employee_id, job_position_id, rating, note, job_interview_status_id, job_interview_type_id, is_active)
VALUES ('2023-03-03', '14:00:00', 'Torino', 5, 4, 6, 2, 'Buone capacità comunicative', 1, 3, true);
